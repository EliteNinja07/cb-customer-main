...
export default () => {
  ...
  const { lang } = useMyIntl("HowdoIconnectmywallets");
  return (
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Text fontSize="1rem" pt={6}>
              ...
              {lang[10]}
              <Link color="#1652f0" href="https://metamask.io/download/">
                {lang[11]}
              </Link>
              {lang[12]}
            </Text>
            ...
            <Text fontSize="1rem" pt={6}>
              ...
              <Link
                color="#1652f0"
                href="/home/Set-up-the-Coinbase-Wallet-browser-extension"
              >
                {lang[36]}
              </Link>
              .
