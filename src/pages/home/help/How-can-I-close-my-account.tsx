...
export default () => {
  ...
  const { lang } = useMyIntl("HowcanIclosemyaccount");
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/4NVa8pR1ZEitpKQsj8Fady/99185e6a77a33745e34f997aaff92f0f/Close_account_consumer_how_can_I_close_my_account.png" />
            </Flex>
            <Text fontSize="1rem" pt={6}>
              {lang[13]}
            </Text>
