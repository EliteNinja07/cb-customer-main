...
export default () => {
  ...
  const { lang } = useMyIntl(
    "UsingTurboTaxorCoinTrackertoreportoncryptocurrency"
  );
  return (
      ...
      <Flex w="100%" flexDir="column" margin="0 auto" px={5}>
        ...
        <Flex pt={10} flexWrap="wrap">
          ...
          >
            ...
            <Flex w="full">
              <Image src="https://images.ctfassets.net/7ca8qfn907uv/7JP71GNIwxueZqK5JoNcUu/b4d91dcb9efb9c8f437d2034ae997d5d/CoinTracker_Tax_reporting.png" />
            </Flex>
            <Alert
              status="info"
              bg="#f5f8ff"
